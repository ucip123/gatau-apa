...
if (!($name && $id)) {
  echo "<script>window.location.href = 'login.php';</script>";
    ...
    <meta name="description" content="A simple public chatting website written in Wavel, by Kenzu Verioble" />
    <meta name="keywords" content="chat,vtchat,php,js,replit" />
    <meta name="author" content="Kenzu Verioble" />
  ...
  <div class="chatBase">
    ...
    <script>
      ...
      function getMessages(result) {
        ...
        msgs2 = [];
        msgs.forEach((msg) => {
          msgs2.push('<div style="border-bottom:1px solid rgba(255,255,255,0.6);padding:10px;font-size:20px;word-wrap:break-word" onpointerup="reply(this.innerText)">' + msg + '</div>')
        });
